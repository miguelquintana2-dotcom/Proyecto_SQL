...
1. El 62.8% de los despachos completados, correspondientes a 53,672 de los 85,410 viajes totales, se concentró en 59 camiones del año 2015. Asimismo, 92 unidades superan el umbral crítico de 1.35 millones de millas acumuladas. Dado que el rendimiento térmico es homogéneo entre los modelos 2015 y 2021, manteniéndose entre 6.47 y 6.51 millas por galón, el recambio de unidades responde a la mitigación del riesgo mecánico por fatiga estructural y no a variaciones en la eficiencia de combustible.

2. La conciliación entre el gasto registrado por los sensores del motor y las transacciones pagadas con tarjeta corporativa expone diferencias que superan los 1,000 galones en servicios individuales. Estos desvíos generan impactos monetarios negativos de entre 4,500 y 5,600 dólares por viaje en los casos observados. El hallazgo evidencia una vulnerabilidad de control transaccional al no existir topes de compra vinculados a la capacidad física del tanque ni al consumo real en carretera.

3. La plantilla operativa presenta una alta madurez laboral: el 66% del personal activo cuenta con más de 10 años de trayectoria, sumando 82 conductores con licencia profesional clase A y un despacho equilibrado de 640 a 690 viajes por chofer entre las distintas bases. No obstante, la existencia de valores nulos en los campos de asignación de chofer, tracto y remolque dentro de los registros de viaje y combustible fragmenta la trazabilidad total de los activos en servicios completados.